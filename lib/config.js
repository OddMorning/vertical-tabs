  ...
  general: {
    ...
    properties: {
      ...
      normalizeTooltips: {
        ...
        type:        'boolean',
        default:     false,
        description: 'Moves tab tooltips to side. It\'s unstable a bit because tooltips still appear below tabs if you move cursor too quick before they were displayed for the first time.',
        order:       4,
      },
    },
  },
