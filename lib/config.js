  ...
  general: {
    ...
    properties: {
      ...
      normalizeTooltips: {
        ...
        type:        'boolean',
        default:     true,
        description: 'Moves tab tooltips to the left or right side. This option looks stable but if you\'re having some kind of issues like freezes when moving cursor over tabs or whatever, turn it off',
        order:       4,
      },
    },
  },
