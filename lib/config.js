    ...
    properties: {
      tabsPlacement: {
        ...
        enum:    [
          ...
          {value: 'tree-view', description: 'Embedded'},
        ],
        order:   1,
      },
      scrollTabs: {
      ...
      normalizeTooltips: {
        title:       'Fix Tooltips Placement',
        type:        'boolean',
        default:     true,
        description: 'Moves tooltips to the left or right side (depends on tab placement). Since it\'s impossible to change tooltip position the legal way, this option uses some workarounds',
        order:       4,
      },
    },
  },
  tab: {
    ...
    properties: {
      height: {
        ...
        description: 'Atom before version 1.17 had `Spacious` tabs and since 1.17 they became `Compact`',
        order:       1,
      },
      customHeight: {
